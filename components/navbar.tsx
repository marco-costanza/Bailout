...
export default function Navbar() {
  ...
  return (
    <>
            ...
            <div className="md:hidden border-t border-white/10 bg-background px-2 pb-4 pt-2">
              <div className="flex flex-col space-y-2">
                ...
                <button
                  ...
                  className="block w-full text-left rounded-md px-3 py-2 text-base font-medium text-text-secondary hover:text-primary hover:bg-white/5 transition-colors"
                >
                  Area Riservata
                </button>
                <div className="pt-2">
      ...
      {/* Aggiunta del Popup di Redirect qui */}
      <RedirectPopup 

...
### 3. Fare il commit
- In alto nel pannello Source Control c’è una **casella di testo**: è lì che scrivi il **messaggio di commit**.
- Scrivi una frase chiara (es. “Aggiungi logo Bailout al sito”).
- Poi clicca il pulsante **✓ Commit** (o **Commit** con icona check) accanto alla casella.
- Se non vedi il pulsante, a volte si chiama **Commit** nel menu **...** (tre puntini).

### 4. Inviare su GitHub (Push)
- Dopo il commit vedrai **Sync Changes** o **Push** (o un’icona con freccia).
...
### Esempi buoni
- `Aggiungi logo Bailout al sito e .gitignore per .DS_Store`
- `Aggiorna testo hero con nuovo slogan`
- `Correggi link Twitter nel team`
- `Aggiungi sezione Mempool con collaboratori`
...
### Opzionale: seconda riga
Se serve più contesto, puoi usare una seconda riga vuota e poi un paragrafo (molti lo fanno per commit più importanti). Per il sito Bailout di solito basta **una riga chiara**.
...
Dopo il commit puoi fare **Push** per aggiornare GitHub e quindi Vercel.

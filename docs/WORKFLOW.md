# Workflow Bailout: da Cursor a Vercel
...
| **3. Push** | Invii i commit dal tuo computer a GitHub | Cursor: pulsante “Sync” o “Push” in Source Control |
...
- Esempi buoni: “Aggiungi logo Bailout al sito”, “Correggi link contatti nel footer”.
...
4. **Se qualcosa va storto:** puoi tornare a un commit precedente (vedi sotto “Backup e ripristino”).
...
Se in futuro vorrai “tornare indietro” a una versione precedente, potrai farlo proprio grazie a quei commit (in Cursor puoi chiedere: “torna al commit dove avevo aggiunto il logo”).
...
| Inviare su GitHub | Source Control → pulsante **Sync Changes** o **Push** |
| Vedere la cronologia dei commit | Source Control → clicca sui tre puntini **...** → **View History** (o apri il pannello Timeline in basso) |
